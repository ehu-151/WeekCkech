 ...
 */
data class AddEditTaskItemModel(val layoutid: Int, val imageId: Int, val componentType: Int, val text: String = "", val hintText: String = "Title", val spinnerItem: ArrayList<String>? = null) {
    companion object {
