...
class AddEditTaskPresenter(val addEditTaskView: AddEditTaskContract.View) : AddEditTaskContract.Presenter {
    ...
    override fun loadTaskConfigEditRow() {
        ...
        lists.add(AddEditTaskItemModel(R.id.edit_include_title, R.drawable.ic_title_white_24dp, model.EDITTEXT, "タイトル"))
        lists.add(AddEditTaskItemModel(R.id.edit_include_detail, R.drawable.ic_notes_white_24dp, model.EDITTEXT, "詳細"))
        lists.add(AddEditTaskItemModel(R.id.edit_include_limittime, R.drawable.ic_access_time_white_24dp, model.TEXTVIEW))
