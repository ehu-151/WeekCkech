...
class AddEditTaskPresenter(val addEditTaskView: AddEditTaskContract.View) : AddEditTaskContract.Presenter {
    override fun enterTimePicker() {
        addEditTaskView.showTimePicker()
    }
...
//        }
    ...
    override fun loadTaskConfigEditRow() {
        ...
        lists.add(AddEditTaskItemModel(R.drawable.ic_title_white_24dp, model.EDITTEXT, hintText = "タイトル"))
        lists.add(AddEditTaskItemModel(R.drawable.ic_notes_white_24dp, model.EDITTEXT, hintText = "詳細"))
        lists.add(AddEditTaskItemModel(R.drawable.ic_access_time_white_24dp, model.TEXTVIEW, text = "12:00"))
        lists.add(AddEditTaskItemModel(R.drawable.ic_notifications_white_24dp, model.SPINNER, spinnerItem = arrayListOf("1H前", "2H前", "12時")))
        lists.add(AddEditTaskItemModel(R.drawable.ic_today_white_24dp, model.SPINNER, spinnerItem = arrayListOf("月", "火", "水", "木", "金", "土", "日")))
